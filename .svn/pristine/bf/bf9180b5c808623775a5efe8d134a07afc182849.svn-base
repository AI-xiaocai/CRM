											...
											<TBODY>
												...
												<s:iterator value="linkManList" var="linkMan">
														<TR
															...
															<TD>
															<a href="${pageContext.request.contextPath }/linkman_toUpdatePage.action?lid=<s:property value="#linkMan.lid"/>">修改</a>
															&nbsp;&nbsp;
															<a href="${pageContext.request.contextPath }/linkman_delete.action?lid=<s:property value="#linkMan.lid"/>">删除</a>
															</TD>
														</TR>
												</s:iterator>
											</TBODY>
