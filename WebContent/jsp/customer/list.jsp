											...
											<TBODY>
												...
												<s:iterator value="customerList" var="customer">
													<TR
														...
														<TD><s:property value="#customer.dictCustLevel.dname"/></TD>
														...
														<TD>
														<a href="${pageContext.request.contextPath }/customer_toUpdatePage.action?cid=<s:property value="#customer.cid"/>">修改</a>
														&nbsp;&nbsp;
